		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="index.html">UNINOTES <em>.</em></a></div>
				</div>
					...
					<ul>
						...
						<li class="has-dropdown">
							...
							<ul class="dropdown">
								...
								<li><a href="#">Student Uploads</a></li>
			...
			<div class="row">
					...
					<form action="includes/message.inc.php" method="POST">
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="name" class="form-control" placeholder="Your firstname" name="fname">
							</div>
						</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="address">198 West 21th Street, <br> Kolfe Keraniyo Addis Ababa AA 10016</li>
							<li class="phone"><a href="tel://1234567920">+ 2519 4470 1899</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">yabsmart5@gmail.com</a></li>
							<li class="url"><a href="http://hireyab">hireyab.cf</a></li>
						</ul>
					</div>
	...
	<footer id="gtco-footer" role="contentinfo">
		<div class="gtco-container">
			<div class="row row-p	b-md">
				...
				<div class="col-md-4">
					<div class="gtco-widget">
						<h3>About <span class="footer-logo">UNINOTES<span>.<span></span></h3>
			...
			<div class="row copyright">
				<div class="col-md-12">
					<p class="pull-left">
						<small class="block">&copy; 2018 UNINOTES. All Rights Reserved.</small> 
